...
import { TelephoneDeleteDialogComponent } from '../../../../../../main/webapp/app/entities/telephone/telephone-delete-dialog.component';
    ...
    describe('Telephone Management Delete Component', () => {
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [TelephoneDeleteDialogComponent],
                providers: [
                    TelephoneService
                ]
            })
