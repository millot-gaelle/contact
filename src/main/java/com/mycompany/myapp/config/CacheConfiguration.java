...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.mycompany.myapp.domain.Personne.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Adresse.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Telephone.class.getName(), jcacheConfiguration);
